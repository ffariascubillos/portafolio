...
$sql_mostrar = 'SELECT * FROM concursosc';
            ...
            <tbody>
                <?php foreach($re as $r): ?>
                    <tr>
                        ...
                        <td><p class="receta"><?php echo $r['receta']; ?></p></td>
                        <td><a target="_blank" href="<?php echo $r['url_img']; ?>"><img class="thumb" width="100%" src="<?php echo $r['url_img']; ?>"></a></td>
